...
public class LoginnPage {
	...
	By personal = By.xpath("//span[text()= 'Personal']");
	By singOnBtn = By.xpath(
	...
	By warningMsg = By.xpath("//h3[text()='Incorrect user ID or password']");
	By warningMsg2 = By.xpath("//div[@id='error']");

	By enrollInOnlineBanking = By.linkText("Enroll In Online Banking");
